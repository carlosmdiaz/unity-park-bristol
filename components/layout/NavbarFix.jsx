...
import MyDropdownFix from "./MyDropDownFix";
  ...
  return (
    <nav className="fixed w-[100vw] h-24 shadow-xl bg-[#0C1E28] text-white m-0 z-[1000]">
      <div className="flex justify-between items-center h-full w-[100vw] px-4 2xl:px-16">
        <Link href="/" className="h-full md:p-2 p-5 ml-2">
          <Image
        ...
        <div className="hidden sm:flex justify-evenly">
          <ul className="hidden sm:flex">
            ...
            <Link href="/visit">
              <li className="ml-5 hover:border-b text-xl hover:text-[#AE895A] list-none">Directory</li>
            </Link>
          </ul>
          <ul className="hidden sm:flex items-center px-3">
            <Link href="https://www.instagram.com/unityparkbristol/" target="_blank" className="pl-1 hover:text-[#AE895A]">
              <AiOutlineInstagram size={30} />
            </Link>
            <Link href="https://www.facebook.com/profile.php?id=100093514986419" target="_blank" className="pl-1 hover:text-[#AE895A]">
